...
###########################################################################
## Python code generated with wxFormBuilder (version 3.9.0 Apr 24 2021)
...
class frmArchInstall ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		bMethod.Add( self.m_chkUnsfs, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )

		self.m_chkSfs = wx.CheckBox( sbMethod.GetStaticBox(), wx.ID_ANY, u"Rsync", wx.DefaultPosition, wx.DefaultSize, 0 )
		bMethod.Add( self.m_chkSfs, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )
