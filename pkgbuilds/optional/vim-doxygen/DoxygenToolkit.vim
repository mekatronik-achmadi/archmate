...
if !exists("g:DoxygenToolkit_addgroupTag")
  let g:DoxygenToolkit_addgroupTag = "@addtogroup "
endif
...
""""""""""""""""""""""""""
" Doxygen file start-end comment
""""""""""""""""""""""""""
function! <SID>DoxygenFileFunc()
  ...
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_addgroupTag
  exec "normal o".s:interCommentTag."@{ "
  if ( g:DoxygenToolkit_endCommentTag != "" )
    exec "normal o".s:endCommentTag
  endif
  ...
  exec "normal o"
  exec "normal o"
  exec "normal A".strpart( s:startCommentTag, 0 )." @} ".s:endCommentTag
...
""""""""""""""""""""""""""
" Doxygen file start comment
""""""""""""""""""""""""""
function! <SID>DoxygenFileStartFunc()
  call s:InitializeParameters()
...
""""""""""""""""""""""""""
" Doxygen file end comment
""""""""""""""""""""""""""
function! <SID>DoxygenFileEndFunc()
  call s:InitializeParameters()
...
command! -nargs=0 DoxStart :call <SID>DoxygenFileStartFunc()
command! -nargs=0 DoxEnd :call <SID>DoxygenFileEndFunc()
